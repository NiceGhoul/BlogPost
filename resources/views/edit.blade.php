    ...
    <div id="overlay" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-50 flex items-center justify-center">
        <div class="relative bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 max-w-8xl w-full h-auto">
            ...
            <form action="/posts" method="POST">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-610">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="body" name="body" rows="17"
                            class=" @error('body') border-red-500 @enderror block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
